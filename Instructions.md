...
La compañía Post Ltda. tiene un microservicio con algunas Apis expuestas para un nuevo proyecto de front. El Arquitecto de software de la compañía le ha solicitado solucionar los siguientes problemas y mejorar el código actual de acuerdo con las buenas prácticas de desarrollo del que usted tenga conocimiento.
...
6. Mejore el código con las buenas prácticas que conozca.

## Datos importantes

Se adjunta Archivo .bak para ser importado en la Bd local, si por versión de SQL Server no puede reestablecer el backup ejecute el script JujuTests.Script.sql.

Recuerde verficar la cadena de conexion de la BD.

Al terminar la prueba por favor enviar la solución al email

**Aspirantes al equipo de desarrollo:**  
andres.rodriguez@juju.com.co

**Aspirantes al equipo de innovación:**  
